...
sudo docker run -d --name nginx-website -p 80:80 -p 443:443 --network website -v /etc/letsencrypt/archive/www.anthony-pillot.com/:/etc/nginx/certs anthonypillot/website